...
import { AVAILABILITY, JOURNEYS, contactFor } from "@/lib/marketing/practice-site";
...
// had to remember.
//
// There is deliberately no sign-in form. The specifications describe forms, but the roles they route to
// (doctor, receptionist, practice administrator, enterprise administrator, patient) do not exist in this
// application and neither do the four workspaces they land in. A form that authenticates nobody into
// nothing reads as a broken product rather than an unreleased one.
