...
import DependencyManager from "@/app/super-admin/studio/dependencies/DependencyManager";
...
export default async function StudioDependenciesPage() {
  ...
  const dep = await loadDependencies(admin, hid, isSuper);
  ...
  return (
    <div className="max-w-6xl">
      <div className="flex items-start justify-between gap-3 mb-5">
        <div>
          <p className="text-[11px] font-semibold text-indigo-500 uppercase tracking-widest mb-0.5">CST-105 · Dependency Manager</p>
