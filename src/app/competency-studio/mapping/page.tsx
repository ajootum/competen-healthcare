...
export default async function StudioMappingPage() {
  ...
  const map = await loadMappingStudio(admin, hid, isSuper);

  return (
    <div className="max-w-6xl">
      <div className="flex items-start justify-between gap-3 mb-5">
        <div>
          <p className="text-[11px] font-semibold text-indigo-500 uppercase tracking-widest mb-0.5">CST-104 · Mapping Studio</p>
