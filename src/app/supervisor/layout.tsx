...
// Shift Supervisor Workspace (SSW-001) — the real-time operational command
// centre for a clinical shift. Role-scoped to operational coordinators
// (charge nurse / shift supervisor = assessor tier, and admins).

const NAV = [
  { label: "Dashboard",             href: "/supervisor",                                icon: "🖥️", exact: true },
  { label: "Patient Operations",    href: "/supervisor/operations?section=ward",        icon: "🛏️" },
  { label: "Staff Operations",      href: "/supervisor/operations?section=shifts",      icon: "👥" },
  { label: "Clinical Coordination", href: "/supervisor/operations?section=assignments", icon: "🔗" },
  { label: "Patient Safety",        href: "/supervisor/operations?section=safety",      icon: "🛡️" },
  { label: "Task Management",       href: "/supervisor/operations?section=care",        icon: "✅" },
  { label: "Handover Centre",       href: "/supervisor/handover",                       icon: "🔄" },
  { label: "Communication Centre",  href: "/supervisor/communication",                  icon: "💬" },
  { label: "AI & Intelligence",     href: "/supervisor/ai",                             icon: "✨" },
  { label: "Analytics & Reports",   href: "/supervisor/analytics",                      icon: "📊" },
  { label: "Tools & Settings",      href: "/supervisor/settings",                       icon: "⚙️" },
];
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm mt-1">The Shift Supervisor workspace is for charge nurses, shift supervisors and managers.</p>
    ...
    <div className="min-h-screen bg-gray-50 font-[family-name:var(--font-geist-sans)]">
      <header className="md:hidden fixed top-0 left-0 right-0 z-40 bg-[#0a2e38] shadow-lg">
        <div className="h-12 flex items-center gap-2 px-3">
          ...
          <span className="min-w-0">
            ...
            <span className="block text-teal-300/60 text-[10px] leading-tight">Shift Supervisor</span>
          </span>
      ...
      <div className="flex">
        <aside data-sidebar className="hidden md:flex w-56 h-screen bg-[#0a2e38] flex-col py-6 px-4 fixed top-0 left-0 z-20">
          <SidebarToggle />
          <Link href="/supervisor" className="flex items-center gap-2 mb-6 px-2" data-sb-item>
          ...
          <div className="px-3 mb-4" data-sb-label>
            <span className="text-[10px] font-bold text-teal-400/70 uppercase tracking-widest">Shift Supervisor</span>
          </div>
