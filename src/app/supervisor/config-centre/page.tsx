...
const MODULES = [
  ...
  { n: 3, icon: "🧰", title: "Professional Toolkit", desc: "Clinical tools, calculators and quick reference resources.", items: ["Clinical Calculators", "PEWS / NEWS Tools", "Drug Calculators", "Protocols & Guidelines", "Policy & Competency Library"], action: "Open Toolkit", href: null, tone: "violet" },
