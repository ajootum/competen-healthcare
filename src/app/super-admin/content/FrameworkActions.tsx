    ...
    <>
      <button onClick={() => setOpen(true)} title="New framework"
        className={compact
          ...
          : "px-4 py-2 bg-teal-700 text-white text-sm font-semibold rounded-lg hover:bg-teal-700 transition-colors"}>
        {compact ? "+ New" : "+ Add Framework"}
      </button>

      {open && (
        <Modal open title="New Framework" onClose={() => setOpen(false)}>
