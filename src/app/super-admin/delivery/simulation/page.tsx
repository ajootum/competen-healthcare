    ...
    <div className="max-w-4xl">
      <div className="flex items-start justify-between gap-3 mb-5">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-0.5">Deliberate-practice participation and coverage — with structured debriefs and reinforcement follow-up.</p>
        </div>
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
              <div className="px-4 py-2.5 border-b border-gray-50"><p className="text-[11px] text-gray-500">Coverage by scenario type</p></div>
              {q.types.length === 0 ? (
                <p className="text-xs text-gray-500 px-4 py-8 text-center">No practice sessions yet.</p>
              ) : (
                <div className="divide-y divide-gray-50">
                  {q.types.map(t => (
                    <div key={t.type} className="flex items-center gap-3 px-4 py-2.5">
                      ...
                      <span className="text-[11px] text-gray-500 shrink-0">{t.sessions}</span>
            ...
            <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
              <div className="px-4 py-2.5 border-b border-gray-50"><p className="text-[11px] text-gray-500">Recent sessions</p></div>
              {q.recent.length === 0 ? (
                <p className="text-xs text-gray-500 px-4 py-8 text-center">—</p>
              ) : (
                <div className="divide-y divide-gray-50">
                  {q.recent.map((r, idx) => (
