    ...
    <div className="bg-white rounded-xl border border-gray-200">
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-2 mt-4">
          <button onClick={act} disabled={busy} className="text-sm font-semibold bg-teal-700 hover:bg-teal-800 text-white rounded-lg px-4 py-2 disabled:opacity-60">{busy ? "Working…" : tab === "create" ? "Create policy" : "Submit for approval"}</button>
