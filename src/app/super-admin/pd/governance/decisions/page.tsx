...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-010 §2"
      purpose="Governed material decisions, their approvals, conditions and history."
      willShow="each governed decision with its approver, its conditions and its record, including emergency decisions awaiting retrospective review."
    />
  );
}
