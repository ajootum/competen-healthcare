...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Audit & Evidence"
      spec="CPR-PD-010 §2"
      purpose="The evidence repository and index, audit requests, findings and assurance traceability."
      willShow="evidence indexed to the control or obligation it supports, and the audit findings drawn from it."
    />
  );
}
