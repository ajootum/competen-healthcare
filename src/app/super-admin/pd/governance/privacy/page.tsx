...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-010 §2"
      purpose="Practice privacy, data lifecycle, access, sharing, retention and data-governance oversight."
      willShow="what data the product holds, on what basis, for how long, and who may reach it."
    />
  );
}
