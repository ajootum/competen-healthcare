...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Exceptions & Risk Acceptance"
      spec="CPR-PD-010 §2"
      purpose="Time-bounded exceptions, waivers and formal residual-risk acceptance."
      willShow="each accepted exception, who accepted the residual risk, and when that acceptance expires."
    />
  );
}
