...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-010 §2"
      purpose="Applicable obligations, standards, policies, commitments and their due dates."
      willShow="each obligation, what satisfies it, who owns it and when it falls due."
    />
  );
}
