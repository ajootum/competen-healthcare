...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-010 §2"
      purpose="The authoritative register of material Practice product risks and their treatments."
      willShow="each risk with its assessment, owner, treatment plan and review date."
    />
  );
}
