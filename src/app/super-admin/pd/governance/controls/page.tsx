...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Controls & Assurance"
      spec="CPR-PD-010 §2"
      purpose="Control catalogue, design and operating effectiveness, testing and remediation."
      willShow="each control, when it was last tested, whether it was effective, and what remediation is outstanding."
    />
  );
}
