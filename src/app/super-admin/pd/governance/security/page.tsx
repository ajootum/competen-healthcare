...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-010 §2"
      purpose="Product security risks, control assurance and significant security governance."
      willShow="security risks and control assurance at the governance level, distinct from the operational signals Product Health carries."
    />
  );
}
