...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-012 §3"
      purpose="The canonical catalogue of meaningful Practice capabilities and their lifecycle metadata."
      willShow="each capability with a stable namespaced key, domain, named owner, lifecycle stage, current release and dependencies."
    />
  );
}
