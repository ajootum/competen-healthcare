...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-012 §2"
      purpose="Plan and tier mapping, without duplicating the Commercial workspace's plan truth."
      willShow="which plan each capability belongs to, referencing the plan catalogue Commercial owns rather than restating it."
    />
  );
}
