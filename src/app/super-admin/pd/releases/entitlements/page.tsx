...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Entitlements & Availability"
      spec="CPR-PD-012 §2"
      purpose="Which Practice, plan or segment is permitted to reach a capability."
      willShow="the entitlement rules that decide who can reach each capability, and who currently does."
    />
  );
}
