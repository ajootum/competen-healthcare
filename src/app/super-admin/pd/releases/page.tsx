...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Releases & Capabilities"
      spec="CPR-PD-012 §2–3"
      purpose="Executive release posture: active rollouts, readiness, blocked changes and what needs attention."
      willShow="releases in flight, rollouts in progress, readiness gates and blocked changes, read over the capability registry that names what Competen Practice can actually do."
    />
  );
}
