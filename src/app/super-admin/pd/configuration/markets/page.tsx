...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-011 §2"
      purpose="Country and market scope, locale, timezone, formats and market-specific product behaviour."
      willShow="each market's locale, timezone, date and number formats, and its market-specific product behaviour."
    />
  );
}
