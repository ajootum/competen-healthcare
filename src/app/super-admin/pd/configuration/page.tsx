...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-011 §2–3"
      purpose="Configuration posture, pending and high-risk changes, drift, invalid states and recent changes."
      willShow="what is configured away from default, what change is pending approval, where configuration has drifted or become invalid, and what changed recently — across the declared hierarchy of platform-enforced rule, product default, market override, plan or segment override, Practice configuration and practitioner preference."
    />
  );
}
