...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-011 §2"
      purpose="Governed clinical workflow lists, parameters, safety-sensitive defaults and clinical behaviour."
      willShow="clinical lists and parameters with their safety classification and the approval each change requires."
    />
  );
}
