...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-011 §2"
      purpose="Commercial product behaviour that is configuration rather than plan, pricing or subscription truth."
      willShow="the commercial behaviour that is genuinely a setting, kept deliberately separate from the plan and subscription records the Commercial workspace owns."
    />
  );
}
