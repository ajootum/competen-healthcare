...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Practice Defaults"
      spec="CPR-PD-011 §2"
      purpose="Default Practice-level behaviour and onboarding configuration."
      willShow="the defaults a new Practice starts with, and which of them a Practice is permitted to change."
    />
  );
}
