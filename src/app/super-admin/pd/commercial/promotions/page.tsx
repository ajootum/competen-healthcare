...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-007H"
      purpose="Controlled offers, codes, eligibility, validity and commercial impact."
      willShow="the offers in force, who is eligible for them, how long they run and what they cost."
