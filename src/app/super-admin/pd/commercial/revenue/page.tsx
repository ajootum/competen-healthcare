...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-007E"
      purpose="Recurring revenue trends, per-customer averages and revenue segmentation."
      willShow="recurring revenue over time, average revenue per customer and per paying customer, and segmentation by plan, market and payer model."
