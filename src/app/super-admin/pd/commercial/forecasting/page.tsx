...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Forecasting"
      spec="CPR-PD-007J"
      purpose="Scenario-based three-to-twelve-month revenue and subscriber forecasting."
      willShow="forecast scenarios with their assumptions and their version visible beside the projection, never a projection on its own."
