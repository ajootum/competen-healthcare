...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-007G"
      purpose="Commercial churn, renewal, downgrade, cancellation and save intelligence."
      willShow="cancellations, downgrades and renewals with their stated reasons, and the outcome of save attempts."
