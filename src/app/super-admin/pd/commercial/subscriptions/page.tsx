...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Subscriptions"
      spec="CPR-PD-007C"
      purpose="The authoritative product subscription lifecycle and its entitlement relationship."
      willShow="the subscription record for each Practice, its lifecycle and the entitlements it grants."
