...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Commercial"
      spec="CPR-PD-007 §2–3"
      purpose="The executive product-economics pulse for Competen Practice, its exceptions and its actions."
      willShow="paid entitlements, active trials, trial-to-paid conversion, recurring revenue, payment failures, commercial churn and upcoming renewals, with the exceptions that need action and drill-through into each authoritative submodule."
