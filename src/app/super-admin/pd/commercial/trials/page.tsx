...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Trials"
      spec="CPR-PD-007B"
      purpose="Trial lifecycle, eligibility, expiry, conversion and extension governance."
      willShow="each trial's state, eligibility, expiry and extension history, and what happened at the end of it."
