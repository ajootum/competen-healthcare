...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Retention"
      spec="CPR-PD-005C"
      purpose="Cohort retention, dormancy, return and churn-related product behaviour."
      willShow="retention by registration cohort, the point at which use lapses, dormancy and return — on one stated cohort definition rather than several unstated ones."
