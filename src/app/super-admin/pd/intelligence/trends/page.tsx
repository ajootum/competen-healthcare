...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-005J"
      purpose="Time-series, period comparisons and release or change overlays."
      willShow="product measures over time with period comparison, and releases, flags and configuration changes overlaid so a movement can be attributed rather than guessed at."
