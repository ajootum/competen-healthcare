...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Practitioner Segments"
      spec="CPR-PD-005H"
      purpose="Compare practitioner-level segments and lifecycle patterns."
      willShow="practitioner segments and how their lifecycle patterns differ from one another."
