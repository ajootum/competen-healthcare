...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-005D"
      purpose="Per-feature usage, penetration, repeat use and adoption pathways."
      willShow="each feature's reach and repeat use, and the paths by which practitioners arrive at it."
