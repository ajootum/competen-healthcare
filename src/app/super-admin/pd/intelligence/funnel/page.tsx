...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-005I"
      purpose="Analyse registration-to-activation and other approved product funnels."
      willShow="stage-by-stage conversion through the approved funnels, and where people stop."
