...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Markets"
      spec="CPR-PD-005F"
      purpose="Compare markets and countries using normalised product metrics."
      willShow="market-by-market comparison on normalised measures, so a large market and a small one can be read side by side."
