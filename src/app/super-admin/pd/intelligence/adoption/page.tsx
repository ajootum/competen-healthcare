...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Adoption"
      spec="CPR-PD-005A"
      purpose="Capability and feature adoption across eligible users and Practices."
      willShow="adoption of each capability measured against the population actually eligible for it rather than against everyone, which is the difference between a real adoption figure and a flattering one."
