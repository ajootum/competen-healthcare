...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Cohorts"
      spec="CPR-PD-005E"
      purpose="Create and compare governed cohorts by registration, activation, plan, market and behaviour."
      willShow="a cohort builder over governed dimensions, with saved definitions reusable across the other intelligence views so that two screens mean the same thing by the same cohort."
