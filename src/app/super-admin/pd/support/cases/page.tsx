...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Support Cases"
      spec="CPR-PD-009 §2"
      purpose="Practitioner and Practice-reported cases, triage, ownership and resolution."
      willShow="each case with its reporter, triage state, owner, response times and resolution."
    />
  );
}
