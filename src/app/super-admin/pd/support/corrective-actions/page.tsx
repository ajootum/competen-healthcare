...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-009 §2"
      purpose="Actions arising from incidents, problems and postmortems, with owners and due dates."
      willShow="each corrective action with its source, owner, due date and completion state."
    />
  );
}
