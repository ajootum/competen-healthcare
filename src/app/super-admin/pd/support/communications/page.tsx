...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Communications"
      spec="CPR-PD-009 §2"
      purpose="Incident and status communications, updates, templates and audience state."
      willShow="what was said about an incident, to which audience, when, and which update is now overdue."
    />
  );
}
