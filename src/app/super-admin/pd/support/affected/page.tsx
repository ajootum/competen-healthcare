...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Affected Practices & Practitioners"
      spec="CPR-PD-009 §2"
      purpose="Authorised impact scope and operational contact context, without patient data."
      willShow="which Practices and practitioners an incident actually touches and how to reach them — scoped to what platform staff are permitted to see, and never patient data."
    />
  );
}
