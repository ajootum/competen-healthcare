...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      name="Practice Workspaces"
      spec="CPR-PD-001 §3"
      purpose="The landlord-side workspace register and aggregate operational counts."
      willShow="the register of provisioned Practice workspaces with their operational counts, converged on the same canonical Practice identity that Practices and Practice 360 use, so that the two surfaces cannot disagree about what a Practice is."
    />
  );
}
