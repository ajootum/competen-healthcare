...
export default async function Page() {
  ...
  return (
    <PdNotBuilt
      ...
      spec="CPR-PD-001 §3"
      purpose="The product-operations entry point: launch state, readiness, provisioning exceptions and workspace status."
      willShow="the launch state, the readiness summary, the provisioning exceptions outstanding and the workspace roll-up, each linking to the submodule that owns it. Technical Operations / Diagnostics is not rebuilt here: it points at the existing Practice Operations page, which is the only caller of the provisioning API and carries the IAM-001 §14 gate ledger."
    />
  );
}
