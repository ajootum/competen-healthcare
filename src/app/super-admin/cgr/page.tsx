...
export default async function CgrPlatformPage() {
  ...
  const CORE: Mod[] = [
    ...
    { code: "CGR-006", icon: "📊", label: "Governance Dashboard", desc: "Role-based governance rollup — assurance score, regulatory readiness, competency risk, overdue reviews. The registry KPIs + Assurance dashboard cover it today; a CGR-scoped rollup is the next layer.", href: "/super-admin/cgr/registry", status: "partial" },
    { code: "CGR-007", icon: "🧠", label: "Governance Intelligence & Predictive Risk", desc: "AI risk prediction and governance recommendations over the registry. The governed AI gateway + Assurance intelligence run today; a CGR-grounded copilot is the next layer.", href: "/super-admin/assurance/ai", status: "partial" },
  ];
  const OPS: Mod[] = [
