      ...
      <div className="p-5">
        ...
        {tab === "outcome" && (
          <div className="grid sm:grid-cols-2 gap-3">
            ...
            {openEvents.length === 0 && <p className="sm:col-span-2 text-[11px] text-[var(--cmp-text-warning)]">No open events — log one first.</p>}
          </div>
        )}
        ...
        <div className="flex items-center gap-2 mt-4">
          ...
          <span className="text-[11px] text-gray-500 ml-auto">Real resilience evidence — audit-logged.</span>
        </div>
      </div>
    </div>
  );
