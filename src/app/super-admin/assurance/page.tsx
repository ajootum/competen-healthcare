...
export default async function AssurancePlatformPage() {
  ...
  const ASSESS_EVIDENCE: Mod[] = [
    ...
    { code: "CAPA-004", icon: "📎", label: "Evidence Integrity Platform", desc: "Verification lifecycle over competency evidence — a review queue (verify/flag/reject), integrity issues (expired / suspected duplicates) and an immutable chain-of-custody log. Real over evidence + integrity events (mig 149).", href: "/super-admin/assurance/evidence", status: "real" },
