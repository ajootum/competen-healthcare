...
export default async function ThreeSixtyPage() {
  ...
  return (
    <div className="max-w-6xl">
      ...
      {!ts.provisioned ? (
        <div className="bg-[var(--cmp-surface-warning)] border border-[var(--cmp-color-warning)] rounded-xl p-6 text-sm text-amber-800">Run migration 133 (<code className="text-[11px]">cst_360_assessments</code>) to enable the 360° Designer.</div>
      ) : (
        <>
