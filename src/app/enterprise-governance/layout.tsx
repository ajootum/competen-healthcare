...
export default async function EnterpriseGovernanceLayout({ children }: { children: React.ReactNode }) {
  ...
  const header = await loadHeaderContext(admin, user.id, { currentHref: "/enterprise-governance" });
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="hidden md:block md:ml-56">
        <GlobalHeader
          workspaceTitle="Enterprise Governance"
          workspaceHref="/enterprise-governance"
          user={header.user}
