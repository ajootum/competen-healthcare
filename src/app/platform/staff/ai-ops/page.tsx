  ...
  return (
    <div className="space-y-5">
      ...
      <div className={card}>
        ...
        {ai.live ? (
          <p className="text-sm text-[var(--cmp-text-success)]">✅ AI operational — Anthropic configured and wired end-to-end. {ai.events30d} AI-assisted actions in the last 30 days.</p>
        ) : ai.configured ? (
          <p className="text-sm text-[var(--cmp-text-warning)]">⚠️ A {provLabel(ai.provider)} key is present but not wired end-to-end; AI features report as not configured until a supported provider (Anthropic) is set.</p>
        ) : (
