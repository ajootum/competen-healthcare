...
const IMPACT: Record<string, string> = { High: "bg-[var(--cmp-surface-error)] text-[var(--cmp-text-error)]", Medium: "bg-[var(--cmp-surface-warning)] text-[var(--cmp-text-warning)]", Low: "bg-gray-100 text-gray-600" };
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-3">
        ...
        <Kpi label="High impact" value={k.high} sub="Prioritise" icon="🔺" tone={k.high ? "text-[var(--cmp-text-error)]" : "text-[var(--cmp-text-success)]"} />
        <Kpi label="Patient safety" value={k.safety} sub="Safety category" icon="🛡️" tone={k.safety ? "text-[var(--cmp-text-error)]" : undefined} />
