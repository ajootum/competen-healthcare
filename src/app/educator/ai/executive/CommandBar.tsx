...
// Executive Command Bar (Executive Intelligence spec §24). Single-turn natural-
...
const SUGGESTED = [
  ...
  "Summarise institutional health",
  "Predict accreditation readiness",
  "Run a what-if scenario",
  "Show biggest strategic risks",
  ...
  return (
    <div className="rounded-2xl bg-white/[0.03] border border-white/10 p-4">
      <div className="flex items-center gap-1.5 mb-3">
        <span>⌨️</span>
        <p className="text-[11px] font-bold uppercase tracking-widest text-slate-300">Executive Command Bar</p>
      ...
      <div className="flex gap-2">
        <input value={input} onChange={e => setInput(e.target.value)} onKeyDown={e => e.key === "Enter" && send()} disabled={busy}
          placeholder="Ask Copilot for executive insights, forecasts, scenarios, or recommendations…"
