...
// Institution Command Bar (Institution Intelligence spec §17). Single-turn
...
const SUGGESTED = [
  "How healthy is the institution?",
  "Compare programmes",
...
const ATTACH = ["📎 Attach File", "🏫 Select Context", "🧩 Add Filter", "📄 Use Template"];
  ...
  return (
    <div className="rounded-2xl bg-white/[0.03] border border-white/10 p-4">
      <div className="flex items-center gap-1.5 mb-3">
        <span>⌨️</span>
        <p className="text-[11px] font-bold uppercase tracking-widest text-slate-300">Institution Command Bar</p>
      ...
      <div className="flex gap-2">
        <input value={input} onChange={e => setInput(e.target.value)} onKeyDown={e => e.key === "Enter" && send()} disabled={busy}
          placeholder="Ask Copilot to analyse, predict or recommend for the institution…"
