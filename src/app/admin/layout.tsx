...
import { estateRolesOf, orgRolesOf, ORG_ROLE_CONFIG, type AppRole, type OrgRole } from "@/lib/roles";
...
const ALL_NAV = [
  ...
  { label: "Enterprise Governance", href: "/enterprise-governance", icon: "🏛️", orgRoles: ["chief_officer","org_admin","governance_committee",null] },
...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const header = await loadHeaderContext(adminClient, user.id, { currentHref: "/admin/dashboard" });
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="flex">
        ...
        <main id="main-content" data-content className="flex-1 md:ml-56 px-4 md:px-6 pt-24 md:pt-8 pb-8 max-w-6xl">
          {children}
        </main>
      </div>
    </div>
