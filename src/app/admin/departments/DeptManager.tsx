  ...
  return (
    <>
      <button onClick={openModal}
        className="px-4 py-2 bg-teal-700 text-white text-sm font-semibold rounded-lg hover:bg-teal-700 transition-colors">
        + Add
      </button>
            ...
            <div className="p-6 flex flex-col gap-4">
              ...
              <div className="flex gap-3 pt-1">
                ...
                <button onClick={tab === "dept" ? saveDept : saveUnit} disabled={saving}
                  className="flex-1 px-4 py-2 bg-teal-700 text-white rounded-lg text-sm font-semibold hover:bg-teal-700 disabled:opacity-60">
                  {saving ? "Saving..." : "Save"}
                </button>
              </div>
            </div>
