    ...
    return (
      <section className="rounded-2xl border border-gray-200 bg-white p-4" aria-labelledby="zone1">
        ...
        <div className="mt-3 rounded-xl bg-[var(--cp-primary-soft)] p-3.5">
          ...
          {/* ⚠ THE LOCATION IS ON THIS LINE NOW, AND WAS NOT. It read label · facility · room, which
              skipped the one field startActivity was just made to REQUIRE -- so the product insisted on
              a value at the door and then never showed it back. A mandatory field nobody can see is one
              nobody can notice is wrong, which is the other half of why the control below exists. */}
