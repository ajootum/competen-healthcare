    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          {isCompleted && (
            <div className="bg-[var(--cmp-surface-success)] border border-[var(--cmp-color-success)] rounded-xl px-4 py-2 text-center shrink-0">
              <p className="text-[var(--cmp-text-success)] font-semibold text-sm">✓ Completed</p>
