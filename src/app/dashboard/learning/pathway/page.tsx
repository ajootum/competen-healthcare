...
// its reason; progress is toward competency, not course completion. Relocated
// under the PW-006 My Learning Centre hub (/dashboard/learning) as its deep
// competency-pathway view. Widgets without backing data are omitted.
  ...
  return (
    <div className="max-w-6xl">
      <div className="flex items-center gap-2 text-xs text-gray-400 mb-4">
        ...
        <span>/</span>
        <Link href="/dashboard/learning" className="hover:text-gray-600">My Learning Centre</Link>
        <span>/</span>
        <span className="text-gray-700 font-medium">Competency Pathway</span>
      </div>

      <div className="mb-5">
        <h1 className="text-xl font-bold text-gray-900">My Competency Pathway</h1>
