...
// Human Resources Workspace (HRM-001) — enterprise workforce administration:
// employee lifecycle, positions, onboarding, workforce planning, compliance.

const NAV = [
  { label: "Dashboard",             href: "/human-resources",             icon: "📊", exact: true },
  { label: "Recruitment",           href: "/human-resources/recruitment", icon: "📣" },
  { label: "Workforce Planning",    href: "/human-resources/planning",    icon: "🗺️" },
  { label: "Staff Records",         href: "/human-resources/staff",       icon: "👥" },
  { label: "Position Management",   href: "/human-resources/positions",   icon: "🧩" },
  { label: "Learning Compliance",   href: "/human-resources/learning",    icon: "📚" },
  { label: "Performance",           href: "/human-resources/performance", icon: "🎯" },
  { label: "HR Analytics",          href: "/human-resources/analytics",   icon: "📈" },
  { label: "AI Workforce Advisor",  href: "/human-resources/ai",          icon: "✨" },
  { label: "Settings",              href: "/human-resources/settings",    icon: "⚙️" },
];
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm mt-1">The Human Resources workspace is for HR and workforce administration teams.</p>
    ...
    <div className="min-h-screen bg-gray-50 font-[family-name:var(--font-geist-sans)]">
      <header className="md:hidden fixed top-0 left-0 right-0 z-40 bg-[#0a2e38] shadow-lg">
        <div className="h-12 flex items-center gap-2 px-3">
          ...
          <span className="min-w-0">
            ...
            <span className="block text-teal-300/60 text-[10px] leading-tight">Human Resources</span>
          </span>
      ...
      <div className="flex">
        <aside data-sidebar className="hidden md:flex w-56 h-screen bg-[#0a2e38] flex-col py-6 px-4 fixed top-0 left-0 z-20">
          <SidebarToggle />
          <Link href="/human-resources" className="flex items-center gap-2 mb-6 px-2" data-sb-item>
          ...
          <div className="px-3 mb-4" data-sb-label>
            <span className="text-[10px] font-bold text-teal-400/70 uppercase tracking-widest">Human Resources</span>
          </div>
          ...
          <div className="pt-4 border-t border-teal-800/60">
            <div className="flex items-center gap-2 px-3 py-2">
              <div className="w-7 h-7 rounded-full bg-amber-400 flex items-center justify-center text-amber-900 text-xs font-bold">{profile?.full_name?.[0] ?? "H"}</div>
              <div className="flex-1 min-w-0" data-sb-label>
                <p className="text-white text-xs font-medium truncate">{profile?.full_name}</p>
                <p className="text-amber-300/60 text-[10px]">Human Resources</p>
              </div>
            </div>
