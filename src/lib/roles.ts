...
export const WORKSPACE_CATALOGUE: (WorkspaceLink & { orgRoles: OrgRole[]; appRoles: AppRole[] })[] = [
  ...
  { label: "Competency Studio",       icon: "🎨", href: "/competency-studio",     orgRoles: ["chief_officer","org_admin","governance_committee","competency_coordinator"],       appRoles: ["hospital_admin","educator","assessor","super_admin"] },
