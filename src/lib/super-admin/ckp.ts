...
export async function loadCkp(admin: any) {
  ...
  const modules = [
    { n: 1, name: "Knowledge Studio", desc: "Author every knowledge asset — competencies, CPUs, CKOs, assessments, policies", icon: "🏭", href: "/super-admin/studio", stat: `${draftAssets} in progress`, subs: ["Competency Builder", "CPU Builder", "CKO Builder", "Learning Builder", "Assessment Builder", "AI Authoring"] },
    { n: 2, name: "Competency & Framework Centre", desc: "Competency architecture — libraries, frameworks, domains, crosswalks", icon: "📐", href: "/super-admin/content", stat: `${num(frRes) ?? 0} frameworks`, subs: ["Competency Library", "Framework Library", "Domains", "Role Frameworks", "Crosswalks", "Version History"] },
    { n: 3, name: "Clinical Knowledge Repository", desc: "The knowledge warehouse — CKOs, CPUs, evidence, guidelines, graph", icon: "🗄️", href: "/super-admin/studio/knowledge", stat: `${koTotal} objects`, subs: ["CKO Library", "CPU Library", "Evidence", "Clinical Guidelines", "Knowledge Graph", "Terminology"] },
    { n: 4, name: "Assessment & Validation Centre", desc: "Assessment governance — methods, rubrics, blueprints, psychometrics", icon: "🎯", href: "/super-admin/assessment-methods", stat: `${assessments} assessments`, subs: ["Assessment Methods", "Rubrics & Checklists", "Blueprints", "Validation", "Psychometrics", "Certification Rules"] },
    { n: 5, name: "Knowledge Publishing & Governance", desc: "Move knowledge safely into production — review, approve, publish", icon: "🚦", href: "/super-admin/governance/committees", stat: `${pendingReviews} in review`, subs: ["Review Workspace", "Clinical Review", "Governance Approval", "Publishing Pipeline", "Version Control", "Audit & Archive"] },
    { n: 6, name: "Knowledge Intelligence", desc: "Analytics and AI insight over the clinical knowledge base", icon: "📡", href: "/super-admin/knowledge-graph", stat: coverageScore == null ? "—" : `${coverageScore}% coverage`, subs: ["Knowledge Analytics", "AI Recommendations", "Coverage Analysis", "Duplicate Detection", "Gap Analysis", "Usage Analytics"] },
  ];
