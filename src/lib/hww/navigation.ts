...
export const HWW_NAV_CATALOGUE: NavRule[] = [
  ...
  { key: "shift.my-tasks", section: "Shift", label: "My Tasks", href: "/healthcare-worker/tasks", icon: "✅", badge: "myTasks", order: 110 },
  { key: "shift.medication-schedule", section: "Shift", label: "Medication Schedule", href: "/healthcare-worker/medications", icon: "💊", badge: "medsDue", order: 120 },
  { key: "shift.assignment-inbox", section: "Shift", label: "Assignment Inbox", href: "/healthcare-worker/inbox", icon: "📥", badge: "inbox", order: 130 },
  ...
  { key: "clinical.observations", section: "Clinical", group: "Clinical Assessment", label: "Observations & PEWS",
    labelByUnit: { icu: "Observations & Vitals" }, href: "/healthcare-worker/observations", icon: "📈", badge: "obsDue", order: 200 },
  ...
  { key: "clinical.escalations", section: "Clinical", label: "Escalations", href: "/healthcare-worker/safety", icon: "🚨", badge: "alerts", order: 230 },
  { key: "clinical.procedures", section: "Clinical", label: "Procedures", icon: "🩹", soon: true, order: 240 },

  { key: "communication.messages", section: "Communication", label: "Messages", href: "/healthcare-worker/communication", icon: "💬", badge: "unread", order: 300 },
  ...
  { key: "quality.concerns", section: "Quality Events", label: "Nurse Concerns", href: "/healthcare-worker/concerns", icon: "⚠️", badge: "concerns", order: 410 },
...
export type ResolvedItem = { key: string; label: string; href?: string; icon: string; badge?: string; exact?: boolean; soon?: boolean; group?: string; order: number };
