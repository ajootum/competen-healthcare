-- Migration 050: Patient Operations core (SSW-PO-001 v2) — Patient Card foundation
--
-- The 8-module Patient Operations section runs on ONE operational dataset. This
-- adds the operational (NOT EMR) fields + tables the Patient Card and its
-- consumers need: a consultant + current operational stage on the patient, a
-- movement timeline (chronological operational events), and short operational
-- coordination notes. All RLS-locked to the service-role client.

-- Operational stage + consultant on the patient (operational-lite, not clinical).
...
-- Movement timeline — the chronological operational record for a patient.
...
-- Operational coordination notes (short, not clinical progress notes).
