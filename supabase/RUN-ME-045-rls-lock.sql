-- Competen -- RUN-ONCE: lock landlord/tenant tables with RLS (migration 045).
-- Closes a public-anon-key read exposure on the tables migrations 040-044 created.
-- Apply AFTER 040-044. Paste into the Supabase SQL Editor and Run. Idempotent + reversible.
