...
| §8D workflow health (8 journeys) | *none* | — | No journey emits start, completion or failure | §7's eight journeys with attempt/outcome/duration | Instrument real journeys; synthetic labelled separately | Success over attempts, per journey |
